...
mf = tre.history([('A11 1','portlandite')])
time = mf[0]
t_ca= mf[1]

mf1 = tre.history([('A11 1','csh(1.6)')])
time1 = mf1[0]
pH= mf1[1]


mf2 = tre.history([('A11 1','calcite')])
time = mf2[0]
t_h= mf2[1]

fig = plt.figure(figsize=(11,13)) 
ax1 = fig.add_subplot(2,3,2)
ax1.plot(time1,t_ca,'r--', marker='x',linewidth=7.0)
ax1.grid()
...
ax2.plot(time,pH,'r--', marker='x',linewidth=7.0)
ax2.grid()
...
#ax1.semilogx(rblk,T,'k--', marker='o')
ax3.plot(time,t_h,'r--', marker='x',linewidth=7.0)
ax3.grid()
...
fig.savefig('minplots.png',bbox_inches='tight') 
fig.savefig('minplots.pdf')